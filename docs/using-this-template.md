...
- ✅ Updates `cmp-locationpicker/build.gradle.kts` with your Maven coordinates, library name, version, and URLs
- ✅ Updates `CONTRIBUTING.md` and `README.MD` with your project info
- ✅ **Creates your package structure:** `cmp-locationpicker/src/commonMain/kotlin/io/github/yourname/yourlibname/`
...
1. **Your new package structure is ready:**
   ```
   cmp-locationpicker/src/commonMain/kotlin/io/github/yourname/yourlibname/
   ```
...
3. **Keep or delete the `fiblib` example:**
   ...
   - Delete it when you're ready:
     ```bash
     rm -rf cmp-locationpicker/src/commonMain/kotlin/fiblib
     rm -rf cmp-locationpicker/src/commonTest/kotlin/fiblib
     ```
...
**In `cmp-locationpicker/build.gradle.kts`:**
```kotlin
android {
...
```bash
mkdir -p cmp-locationpicker/src/commonMain/kotlin/io/github/yourname/yourlibname
mkdir -p cmp-locationpicker/src/commonTest/kotlin/io/github/yourname/yourlibname
```
...
1. Delete `cmp-locationpicker/src/commonMain/kotlin/fiblib/Fibonacci.kt`
2. Delete `cmp-locationpicker/src/commonTest/kotlin/fiblib/FibonacciTest.kt`

### 7.2 Add Your Code

Create your library files in `cmp-locationpicker/src/commonMain/kotlin/yourpackage/`:

```kotlin
// cmp-locationpicker/src/commonMain/kotlin/io/github/yourname/yourlibname/YourClass.kt
...
Create tests in `cmp-locationpicker/src/commonTest/kotlin/yourpackage/`:

```kotlin
// cmp-locationpicker/src/commonTest/kotlin/io/github/yourname/yourlibname/YourTest.kt
package io.github.yourname.yourlibname
...
./gradlew :cmp-locationpicker:jvmTest
./gradlew :cmp-locationpicker:iosSimulatorArm64Test
./gradlew :cmp-locationpicker:wasmJsBrowserTest
```
...
```bash
# Ensure version in cmp-locationpicker/build.gradle.kts is correct
...
2. Update version in `cmp-locationpicker/build.gradle.kts`
3. Commit and push
